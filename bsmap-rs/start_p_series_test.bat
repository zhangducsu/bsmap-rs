...
REM 给Linux脚本权限
echo 正在给测试脚本赋予执行权限...
docker run --rm -v "%~dp0:/workspace/bsmap-rs" ubuntu chmod +x /workspace/bsmap-rs/benchmark/run_ex1_ex2.sh
...
echo ========================================
echo 测试完成！
echo 请查看 benchmark\results\ 目录获取结果
echo ========================================
echo.

REM 列出结果
if exist "%~dp0benchmark\results" (
    dir /b "%~dp0benchmark\results"
)
